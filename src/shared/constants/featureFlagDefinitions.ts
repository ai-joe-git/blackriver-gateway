...
export const FEATURE_FLAG_DEFINITIONS: FeatureFlagDefinition[] = [
  ...
  {
    key: "BlackRiver Gateway_CONTROL_PLANE_PROXY_DIRECT_FALLBACK",
    ...
    descriptionI18nKey: "featureFlagBlackRiver GatewayControlPlaneProxyDirectFallbackDescription",
    category: "network",
    defaultValue: "false",
    type: "boolean",
    requiresRestart: false,
  ...
  {
    key: "BlackRiver Gateway_ALLOW_PRIVATE_PROVIDER_URLS",
    label: "Allow Private Provider URLs",
    description: "Allow provider URLs pointing to private/internal networks",
    descriptionI18nKey: "featureFlagBlackRiver GatewayAllowPrivateProviderUrlsDescription",
    category: "network",
    defaultValue: "false",
    type: "boolean",
    requiresRestart: false,
  ...
  {
    key: "BlackRiver Gateway_ALLOW_LOCAL_PROVIDER_URLS",
    label: "Allow Local Provider URLs",
    description:
      "Allow adding and validating providers on local/private addresses (127.0.0.1, localhost, LAN, private IP ranges) — needed for local OpenAI-compatible models. Enabled by default (BlackRiver Gateway is local-first); turn it OFF to enforce strict public-only blocking if you only use public providers. Cloud-metadata endpoints (e.g. 169.254.169.254) stay blocked either way.",
    descriptionI18nKey: "featureFlagBlackRiver GatewayAllowLocalProviderUrlsDescription",
    category: "network",
    defaultValue: "true",
    type: "boolean",
    requiresRestart: false,
  ...
  {
    key: "BlackRiver Gateway_MCP_ENFORCE_SCOPES",
    label: "MCP Enforce Scopes",
    description: "Enforce scope restrictions on MCP tool access",
    descriptionI18nKey: "featureFlagBlackRiver GatewayMcpEnforceScopesDescription",
    category: "runtime",
    defaultValue: "true",
    type: "boolean",
    requiresRestart: false,
  ...
  {
    key: "BlackRiver Gateway_MCP_COMPRESS_DESCRIPTIONS",
    label: "MCP Compress Descriptions",
    description: "Compress MCP tool descriptions to reduce token usage",
    descriptionI18nKey: "featureFlagBlackRiver GatewayMcpCompressDescriptionsDescription",
    category: "runtime",
    defaultValue: "false",
    type: "boolean",
    requiresRestart: false,
  ...
  {
    key: "BlackRiver Gateway_ENABLE_RUNTIME_BACKGROUND_TASKS",
    label: "Runtime Background Tasks",
    description: "Enable background task processing at runtime",
    descriptionI18nKey: "featureFlagBlackRiver GatewayEnableRuntimeBackgroundTasksDescription",
    category: "runtime",
    defaultValue: "false",
    type: "boolean",
    requiresRestart: false,
  ...
  {
    key: "BlackRiver Gateway_DISABLE_BACKGROUND_SERVICES",
    label: "Disable Background Services",
    description: "Disable all background services (quota refresh, sync, etc)",
    descriptionI18nKey: "featureFlagBlackRiver GatewayDisableBackgroundServicesDescription",
    category: "runtime",
    defaultValue: "false",
    type: "boolean",
    requiresRestart: true,
  ...
  {
    key: "BlackRiver Gateway_RTK_TRUST_PROJECT_FILTERS",
    label: "RTK Trust Project Filters",
    description: "Trust project-level filters from RTK without validation",
    descriptionI18nKey: "featureFlagBlackRiver GatewayRtkTrustProjectFiltersDescription",
    category: "runtime",
    defaultValue: "false",
    type: "boolean",
    requiresRestart: false,
  ...
  {
    key: "BlackRiver Gateway_ENABLE_LIVE_WS",
    ...
    descriptionI18nKey: "featureFlagBlackRiver GatewayEnableLiveWsDescription",
    category: "runtime",
    defaultValue: "true",
    type: "boolean",
    requiresRestart: true,
  ...
  {
    key: "BlackRiver Gateway_CODEX_WS_ENABLED",
    ...
    descriptionI18nKey: "featureFlagBlackRiver GatewayCodexWsEnabledDescription",
    category: "runtime",
    defaultValue: "true",
    type: "boolean",
    requiresRestart: false,
  ...
  {
    key: "BlackRiver Gateway_EMERGENCY_FALLBACK",
    label: "Emergency Fallback",
    description: "Route budget-exhausted requests to the emergency free fallback provider/model.",
    descriptionI18nKey: "featureFlagBlackRiver GatewayEmergencyFallbackDescription",
    category: "runtime",
    defaultValue: "true",
    type: "boolean",
    requiresRestart: false,
  ...
  {
    key: "BlackRiver Gateway_AUTO_SYNC_CODEX_PROFILES",
    ...
    descriptionI18nKey: "featureFlagBlackRiver GatewayAutoSyncCodexProfilesDescription",
    category: "cli",
    defaultValue: "false",
    type: "boolean",
    requiresRestart: false,
  ...
  {
    key: "BlackRiver Gateway_AUTO_SYNC_CLAUDE_PROFILES",
    ...
    descriptionI18nKey: "featureFlagBlackRiver GatewayAutoSyncClaudeProfilesDescription",
    category: "cli",
    defaultValue: "false",
    type: "boolean",
    requiresRestart: false,
  ...
  // ──────────────── Health (3) ────────────────
  {
    key: "BlackRiver Gateway_DISABLE_LOCAL_HEALTHCHECK",
    label: "Disable Local Health Check",
    description: "Disable the local instance health check endpoint",
    descriptionI18nKey: "featureFlagBlackRiver GatewayDisableLocalHealthcheckDescription",
    category: "health",
    defaultValue: "false",
    type: "boolean",
    requiresRestart: false,
  ...
  {
    key: "BlackRiver Gateway_DISABLE_TOKEN_HEALTHCHECK",
    label: "Disable Token Health Check",
    description: "Disable the token validation health check",
    descriptionI18nKey: "featureFlagBlackRiver GatewayDisableTokenHealthcheckDescription",
    category: "health",
    defaultValue: "false",
    type: "boolean",
    requiresRestart: false,
