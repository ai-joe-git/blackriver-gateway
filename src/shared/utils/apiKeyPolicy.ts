...
import { checkTokenLimits } from "@BlackRiver Gateway/open-sse/services/tokenLimitCounter.ts";
import {
  errorResponse,
  buildErrorBody,
...
const PLAYGROUND_KEY_ID_HEADER = "x-BlackRiver Gateway-playground-key-id";
 ...
 * `x-BlackRiver Gateway-playground-key-id` and we resolve the secret server-side.
 *
