 ...
 *
 * Serves the BlackRiver Gateway A2A Agent Card for discovery by other agents.
...
const BASE_URL = process.env.BlackRiver Gateway_BASE_URL || "http://localhost:20128";

/**
 * GET /.well-known/agent.json
 *
 * Returns the BlackRiver Gateway Agent Card that describes this gateway's
 * capabilities as an A2A agent.
 */
export async function GET() {
  const agentCard = {
    name: "BlackRiver Gateway AI Gateway",
    description:
    ...
    skills: [
      ...
      },
      {
        ...
        description:
          "Returns the full catalog of 42 BlackRiver Gateway agent skills (22 API + 20 CLI) " +
