 ...
 * BlackRiver Gateway can resolve it unambiguously. The previous heuristic only prefixed
...
export function LlmChatCard({
  ...
  // Auto-prefix model with providerId to avoid BlackRiver Gateway "Ambiguous model"
