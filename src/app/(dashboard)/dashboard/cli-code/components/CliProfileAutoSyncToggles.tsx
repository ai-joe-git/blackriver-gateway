...
const CODEX_KEY = "BlackRiver Gateway_AUTO_SYNC_CODEX_PROFILES";
const CLAUDE_KEY = "BlackRiver Gateway_AUTO_SYNC_CLAUDE_PROFILES";
 ...
 * Reads/writes the BlackRiver Gateway_AUTO_SYNC_{CODEX,CLAUDE}_PROFILES feature flags via
