...
import { IMAGE_PROVIDERS } from "@BlackRiver Gateway/open-sse/config/imageRegistry.ts";
import { VIDEO_PROVIDERS } from "@BlackRiver Gateway/open-sse/config/videoRegistry.ts";
import { MUSIC_PROVIDERS } from "@BlackRiver Gateway/open-sse/config/musicRegistry.ts";
import {
...
> = {
  ...
  speech: {
    ...
    placeholder: "Hello! Welcome to BlackRiver Gateway, your intelligent AI gateway...",
