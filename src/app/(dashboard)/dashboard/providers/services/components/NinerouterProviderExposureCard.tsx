 ...
 * When enabled, 9Router models appear as `9router/...` in BlackRiver Gateway's model selection.
 */
"use client";
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-text-muted mt-0.5">
            When enabled, discovered models appear in provider selects across BlackRiver Gateway.
          </p>
        </div>
        <Toggle
