...
const COMBO_USAGE_GUIDE_STORAGE_KEY = "BlackRiver Gateway:combos:hide-usage-guide";
                      ...
                      <div>
                        <FieldLabelWithHelp
                          ...
                          help={getI18nOrFallback(
                            ...
                            "When quota usage reaches this threshold, BlackRiver Gateway generates a structured handoff summary before the account is exhausted."
                          )}
                          showHelp={!isExpertMode}
                        />
                        <input
