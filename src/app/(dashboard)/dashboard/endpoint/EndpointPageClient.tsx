      ...
      if (data?.needsLogin && data?.authUrl) {
        ...
        setTailscaleNotice({
          ...
          message: translateOrFallback(
            ...
            "Complete the Tailscale login in the opened browser tab. BlackRiver Gateway will retry automatically."
          ),
        });
      ...
      if (data?.funnelNotEnabled && data?.enableUrl) {
        ...
        setTailscaleNotice({
          ...
          message: translateOrFallback(
            ...
            "Enable Funnel for this device in the opened browser tab. BlackRiver Gateway will keep polling."
          ),
        });
    ...
    <div className="flex flex-col gap-8">
      ...
      <Card>
        ...
        <div className="flex flex-col">
          ...
          {/* Cloud BlackRiver Gateway */}
          <div className="flex items-center gap-3 py-3">
            <span className="material-symbols-outlined text-[18px] text-blue-400 shrink-0">
              cloud
            </span>
            <div className="flex-1 min-w-0">
              <span className="text-sm font-medium">{t("cloudBlackRiver Gateway")}</span>
            </div>
            <span
          ...
          <div className="rounded-lg border border-blue-500/30 bg-blue-500/10 p-4">
            <p className="text-sm font-medium text-blue-300">
              {translateOrFallback(
                ...
                "Installs Tailscale on this machine and prepares BlackRiver Gateway to enable Funnel."
              )}
            </p>
