...
import { handleAudioTranscription } from "@BlackRiver Gateway/open-sse/handlers/audioTranscription.ts";
...
import { attachBlackRiver GatewayMetaToResponse } from "@/domain/BlackRiver GatewayResponseMeta";
...
export async function POST(request) {
  ...
  if (response?.ok) {
    ...
    response = attachBlackRiver GatewayMetaToResponse(response, {
      provider,
      model: resolvedModel,
      costUsd: 0,
