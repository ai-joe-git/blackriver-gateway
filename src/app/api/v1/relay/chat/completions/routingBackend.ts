...
export function getBifrostRoutingConfig(
  ...
  return {
    ...
    apiKey: env.BIFROST_API_KEY || env.BlackRiver Gateway_BIFROST_KEY || undefined,
...
export function resolveRelayRoutingBackend(
  ...
  const configured = env.BlackRiver Gateway_RELAY_BACKEND || env.RELAY_ROUTING_BACKEND;
