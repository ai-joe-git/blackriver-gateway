/**
 * #3571 — `/v1/completions` is the legacy OpenAI Completions API. BlackRiver Gateway routes
 ...
 * the model they asked for, and the `x-BlackRiver Gateway-model` response header
 ...
 * requested identifier (matching the `x-BlackRiver Gateway-model` response header).
 */
