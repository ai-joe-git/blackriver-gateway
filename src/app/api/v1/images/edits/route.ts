...
} from "@BlackRiver Gateway/open-sse/handlers/imageGeneration.ts";
import { withInjectionGuard } from "@/middleware/promptInjectionGuard";
import { getProviderCredentials, clearRecoveredProviderState } from "@/sse/services/auth";
import { parseImageModel, getImageProvider } from "@BlackRiver Gateway/open-sse/config/imageRegistry.ts";
import { errorResponse, unavailableResponse } from "@BlackRiver Gateway/open-sse/utils/error.ts";
 ...
 *    generated through BlackRiver Gateway — we then have its `{conversationId, parentMessageId}`
