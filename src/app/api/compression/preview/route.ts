...
} from "@BlackRiver Gateway/open-sse/services/compression/strategySelector";
import type {
  CompressionConfig,
  CompressionMode,
} from "@BlackRiver Gateway/open-sse/services/compression/types";
import {
  buildCompressionPreviewDiff,
  type HeatmapMode,
} from "@BlackRiver Gateway/open-sse/services/compression/diffHelper";
...
import { ensureEngineBreakdown } from "@BlackRiver Gateway/open-sse/services/compression/engineBreakdown";
import { summarizeEncoderCandidates } from "@BlackRiver Gateway/open-sse/services/compression/engines/headroom/encoderComparison";
import { DEFAULT_MIN_ROWS } from "@BlackRiver Gateway/open-sse/services/compression/engines/headroom/smartcrusher";
