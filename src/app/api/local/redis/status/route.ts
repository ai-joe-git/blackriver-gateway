...
const CONTAINER_NAME = process.env.BlackRiver Gateway_REDIS_CONTAINER_NAME || "BlackRiver Gateway-redis";
const HOST_PORT = process.env.BlackRiver Gateway_REDIS_HOST_PORT || "6379";
