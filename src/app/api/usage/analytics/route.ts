...
export async function GET(request: Request) {
  ...
  try {
    ...
    const { PROVIDER_ID_TO_ALIAS } = await import("@BlackRiver Gateway/open-sse/config/providerModels");
    ...
    const { buildErrorBody } = await import("@BlackRiver Gateway/open-sse/utils/error");
