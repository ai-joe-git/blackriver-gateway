...
import { sanitizeErrorMessage, buildErrorBody } from "@BlackRiver Gateway/open-sse/utils/error.ts";
 ...
 *
 * BlackRiver Gateway Copilot chat endpoint.
 * Accepts user messages about BlackRiver Gateway configuration and returns
