...
import { getAuditStats, queryAuditEntries } from "@BlackRiver Gateway/open-sse/mcp-server/audit";
import {
  isMcpHeartbeatOnline,
  isProcessAlive,
  readMcpHeartbeat,
  resolveMcpHeartbeatPath,
} from "@BlackRiver Gateway/open-sse/mcp-server/runtimeHeartbeat";
import {
  getMcpHttpStatus,
...
export async function GET(request: Request) {
  ...
  try {
    ...
    const scopesEnforced = process.env.BlackRiver Gateway_MCP_ENFORCE_SCOPES === "true";
