...
export async function GET() {
  ...
  try {
    const [
      ...
      import("@BlackRiver Gateway/open-sse/services/rateLimitManager"),
      import("@BlackRiver Gateway/open-sse/services/accountFallback"),
      import("@BlackRiver Gateway/open-sse/services/requestDedup.ts"),
      import("@BlackRiver Gateway/open-sse/services/quotaMonitor.ts"),
      import("@BlackRiver Gateway/open-sse/services/sessionManager.ts"),
