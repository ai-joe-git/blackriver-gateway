...
export const AUTHZ_HEADER_ROUTE_CLASS = "x-BlackRiver Gateway-route-class";

export const AUTHZ_HEADER_AUTH_KIND = "x-BlackRiver Gateway-auth-kind";
export const AUTHZ_HEADER_AUTH_ID = "x-BlackRiver Gateway-auth-id";
export const AUTHZ_HEADER_AUTH_LABEL = "x-BlackRiver Gateway-auth-label";
export const AUTHZ_HEADER_AUTH_SCOPES = "x-BlackRiver Gateway-auth-scopes";

/** CLI sends this header so the local process can call management APIs without login. */
export const CLI_TOKEN_HEADER = "x-BlackRiver Gateway-cli-token";
 ...
 * token matches this process's BlackRiver Gateway_PEER_STAMP_TOKEN (see
 ...
 */
export const PEER_IP_HEADER = "x-BlackRiver Gateway-peer-ip";
 ...
 * proxy hop (e.g. BlackRiver Gateway behind nginx / Caddy / Cloudflare Tunnel) is NOT
 ...
 */
export const VIA_PROXY_HEADER = "x-BlackRiver Gateway-via-proxy";
 ...
 */
export const AUTHZ_HEADER_PEER_LOCALITY = "x-BlackRiver Gateway-peer-locality";
