...
function extractBearer(request: Request): string | null {
  ...
  if (raw) {
    ...
    // client's own non-BlackRiver Gateway token — VS Code Copilot sends one even when the
    // BlackRiver Gateway key lives in the URL path of a /vscode tokenized endpoint) must
