 ...
 *
 * Source of truth for which browser origins may call BlackRiver Gateway over CORS.
...
const STANDARD_ALLOW_HEADERS =
  "Content-Type, Authorization, x-api-key, anthropic-version, x-BlackRiver Gateway-connection, x-internal-test, accept";
