 ...
 *     is set explicitly. The BlackRiver Gateway LOCAL_ONLY rule is enforced at the
...
declare global {
  var __BlackRiver GatewayEmbedWsStarted: boolean | undefined;
}
...
export function initEmbedWsProxy(): void {
  if (globalThis.__BlackRiver GatewayEmbedWsStarted) return;
  ...
  server.listen(port, host, () => {
    globalThis.__BlackRiver GatewayEmbedWsStarted = true;
