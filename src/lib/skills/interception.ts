...
import { BlackRiver Gateway_WEB_SEARCH_FALLBACK_TOOL_NAME } from "@BlackRiver Gateway/open-sse/services/webSearchFallback.ts";
...
const BUILTIN_TOOL_ALIASES: Record<string, string> = {
  [BlackRiver Gateway_WEB_SEARCH_FALLBACK_TOOL_NAME]: "web_search",
};
...
export async function handleToolCallExecution(
  ...
  switch (provider) {
    ...
    case "anthropic": {
      ...
      // blocks untouched, remove the BlackRiver Gateway-handled tool_use blocks, and expose
