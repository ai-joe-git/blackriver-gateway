 ...
 * The PRIMARY key is now derived with a static salt ("BlackRiver Gateway-field-encryption-v1").
 ...
 * a different derived key than the static salt `"BlackRiver Gateway-field-encryption-v1"`. When the
...
const PREFIX = "enc:v1:";
const STATIC_SALT = "BlackRiver Gateway-field-encryption-v1";
