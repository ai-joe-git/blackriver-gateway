 ...
 * trace out of BlackRiver Gateway into their existing workflow.
 *
 * Secrets are *always* masked on export, regardless of the UI state — see
 * Hard Rule #1 (no credentials in artefacts). The BlackRiver Gateway capture source
...
const CREATOR_NAME = "BlackRiver Gateway Traffic Inspector";
