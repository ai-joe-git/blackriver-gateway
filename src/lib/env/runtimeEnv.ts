...
export const webRuntimeEnvSchema = z.object({
  ...
  BlackRiver Gateway_DISABLE_BACKGROUND_SERVICES: optionalBooleanEnv,
  CLOUD_URL: optionalHttpUrl,
  NEXT_PUBLIC_CLOUD_URL: optionalHttpUrl,
  BlackRiver Gateway_PUBLIC_BASE_URL: optionalHttpUrl,
  BlackRiver Gateway_BASE_URL: optionalHttpUrl,
  BASE_URL: optionalHttpUrl,
  NEXT_PUBLIC_BASE_URL: optionalHttpUrl,
  BlackRiver Gateway_PORT: optionalPortEnv,
