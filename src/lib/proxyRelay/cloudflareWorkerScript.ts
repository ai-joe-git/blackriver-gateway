/**
 * Cloudflare Worker source emitter for the BlackRiver Gateway proxy relay.
 *
 ...
 *
 * The BlackRiver Gateway variant intentionally diverges from the upstream PR:
...
export function buildCloudflareWorkerScript(relayAuth: string): string {
  ...
  return `// BlackRiver Gateway Cloudflare Worker proxy relay — generated at deploy time.
