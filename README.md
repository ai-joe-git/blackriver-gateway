...
<img src="./docs/screenshots/MainOmniRoute.png" alt="BlackRiver Gateway Dashboard" width="820"/>

<br/>

# BlackRiver Gateway — AI Routing Infrastructure by BlackRiver AI
...
⭐ Star the repo if BlackRiver Gateway helped you save money and make your work easier. [![Stars](https://img.shields.io/github/stars/ai-joe-git/blackriver-gateway?style=social)](https://github.com/ai-joe-git/blackriver-gateway)
</h3>
...
[![npm version](https://img.shields.io/npm/v/blackriver-gateway?color=cb3837&logo=npm)](https://www.npmjs.com/package/blackriver-gateway)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg?style=flat-square)](LICENSE)

[**Quick Start**](#-quick-start) • [**Combos**](#-combos--the-flagship) • [**Providers**](#-237-ai-providers--90-free) • [**CLI & MCP**](#-full-cli--a2a--mcp) • [**Compression**](#%EF%B8%8F-save-1595-tokens--automatically) • [**Website**](https://blackriver-ai.vercel.app/blackriver-gateway.html)

<br/>

> **Originally created by [diegosouzapw](https://github.com/diegosouzapw) as OmniRoute.** This is a rebranded distribution by [BlackRiver AI Ltd](https://blackriver-ai.vercel.app/). The original MIT license and copyright are preserved in [LICENSE](LICENSE). All features, APIs, env vars, and install paths remain unchanged.
...
| ------------------------- | ---------------------------------------- | --------------------------------------------------------- |
| 📦 **npm (global)**       | `npm install -g blackriver-gateway`               | One command, any OS                                       |
...
```bash
npm install -g blackriver-gateway
blackriver-gateway
```
...
```bash
OMNIROUTE_SKIP_POSTINSTALL=1 npm install -g blackriver-gateway   # CI=1 also skips it
```
